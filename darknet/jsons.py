...
class darknet_recog:
    ...
    def __init__(self, thresh= .1, configPath = "./darknet/cfg/yolov3-tiny.cfg", weightPath = "./darknet/yolov3-tiny-retrained.weights", metaPath= "./darknet/data/obj.data"):
...
if __name__ == "__main__":
    dark = darknet_recog()
    imagePath="./darknet/data/COCO_train2014_000000000127.jpg"
