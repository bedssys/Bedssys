...
class darknet_recog:
    ...
    def __init__(self, thresh= .2, configPath = "./darknet/cfg/yolov3-spp.cfg", weightPath = "./darknet/yolov3-spp.weights", metaPath= "./darknet/data/yolo.data"):
    ...
    def detect_image(self, net, meta, im, thresh=.1, hier_thresh=.5, nms=.45, debug= False):
        #import cv2
...
if __name__ == "__main__":
    dark = darknet_recog()
    imagePath="./darknet/data/person.jpg"
